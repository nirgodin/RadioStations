...
AUDIO_FEATURES_CHUNK_OUTPUT_PATH_FORMAT = r'data/weekly_run/audio_features_chunks/{}.csv'
AUDIO_FEATURES_BASE_DIR = r'data/weekly_run/audio_features_chunks'
AUDIO_FEATURES_DATA_PATH = r'data/weekly_run/audio_features_merged_data.csv'
...
WIKIPEDIA_GENDERS_PATH = r'data/wikipedia/artists_genders.csv'
WIKIPEDIA_ISRAELI_ARTISTS_GENDER_PATH = r'data/wikipedia/israeli_artists_genders.csv'
